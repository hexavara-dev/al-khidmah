export default function Footer() {
    ...
    return (
        <footer className="bg-gradient-to-br from-[#004f52] via-[#006b6e] to-[#008f92] text-white mt-auto">
            <div className="max-w-5xl mx-auto px-6 py-10">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-[#c0eeef] text-sm leading-relaxed">
                            Bersama kami, setiap kebaikan yang Anda berikan menjadi berkah bagi sesama. Mari wujudkan kepedulian nyata.
                        </p>
                        <div className="flex gap-3 mt-4">
                            <a href="#" aria-label="Facebook" className="w-8 h-8 bg-white/15 hover:bg-white/30 rounded-lg flex items-center justify-center transition">
                            ...
                            <a href="#" aria-label="Instagram" className="w-8 h-8 bg-white/15 hover:bg-white/30 rounded-lg flex items-center justify-center transition">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
                            ...
                            <a href="#" aria-label="WhatsApp" className="w-8 h-8 bg-white/15 hover:bg-white/30 rounded-lg flex items-center justify-center transition">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
                    ...
                    {/* Quick Links */}
                    <div>
                        <h3 className="font-bold text-sm uppercase tracking-widest mb-4 text-[#e0fafa]">Tautan</h3>
                            ...
                            {[
                                ...
                                <li key={href}>
                                    <a href={href} className="text-[#b3ecee] text-sm hover:text-white transition flex items-center gap-1.5 group">
                                        <span className="w-1 h-1 rounded-full bg-[#00cacd] group-hover:w-2 transition-all" />
                                        {label}
                                    </a>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-[#a8ecee] text-[10px] uppercase font-semibold tracking-wide">Email</p>
                                    <p className="text-white text-sm">info@alkhidmah.org</p>
                                </div>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-lg mt-0.5">📞</span>
                                <div>
                                    <p className="text-[#a8ecee] text-[10px] uppercase font-semibold tracking-wide">Telepon</p>
                            ...
                            <li className="flex items-start gap-3">
                                <span className="text-lg mt-0.5">📍</span>
                                <div>
                                    <p className="text-[#a8ecee] text-[10px] uppercase font-semibold tracking-wide">Alamat</p>
